...
parser.add_argument(
    "--image_size", type=list, default=[224, 224], help="transformed image size"
)
parser.add_argument(
    "--heatmap_size", type=list, default=[224, 224], help="transformed heatmap size"
)
...
parser.add_argument(
    "--output_n", type=int, default=50, help="number of model's output frames"
)
parser.add_argument(
    "--skip_rate",
    type=int,
...
parser.add_argument(
    ...
    type=int,
    default=2,
    help="dimensions of the origin trajecotry dim",
)
parser.add_argument(
    "--origin_d_scene",
    type=int,
    default=3136,
    help="dimensions of the scene feature dim",
)

parser.add_argument(
    "--input_dim", type=int, default=2, help="dimensions of the input coordinates"
)
parser.add_argument(
    "--output_dim", type=int, default=100, help="dimensions of the output coordinates"
)
parser.add_argument(
    "--embed_dim", type=int, default=512, help="dimensions of the embed dimensions"
)
...
parser.add_argument(
    "--vit_checkpoint_file",
    type=str,
    default="./pretrained_models/upernet_swin_small_patch4_window7_512x512_160k_ade20k_pretrain_224x224_1K_20210526_192015-ee2fff1c.pth",
    help="config_file",
)
...
parser.add_argument(
    ...
    type=int,
    default=6,
    help="num encoder layers in transformers",
)
parser.add_argument(
    "--num_decoder_layers",
    type=int,
    default=6,
    help="num decoder layers in transformers",
)
parser.add_argument(
    "--max_seq_len",
    type=int,
    default=512,
    help="max_seq_len for transformers postion embedding",
)
parser.add_argument("--out_dropout", type=float, default=0.0, help="output dropout")
...
parser.add_argument(
    "--clip_grad", type=float, default=10000, help="select max norm to clip gradients"
)
